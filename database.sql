...
('Wolhwawon Garden', '경기도 수원시 팔달구 인계동', '399 Dongsuwon-ro, Paldal-gu, Suwon-si, Gyeonggi-do', 'Explore', 'Wolhwawon Garden is located in Hyowon Park (효원공원). It is famous among locals for its chinese-style. Many people go here during the fall to look at the fall foliage.', '/images/WolhwawonGarden_1.jpg');
