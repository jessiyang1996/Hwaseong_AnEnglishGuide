...
('Suwon Station', '경기 수원시 팔달구 덕영대로 924', '924 Deogyeongdaero, Paldal-gu, Suwon-si, Gyeonggi-do', 'Shopping', 'Suwon is one of the closest train stations if you live in western Hwaseong. There are many buses that you can take to Suwon Station (1004, 300, 400) as it is a major train station/bus transfer area. Because of this, you will see all kinds of people there. From sunrise until sunset, it is always busy and filled with people. You can always see people shopping or lined up for buses, trains, or KTX. At Suwon Station, you can find all the modern conveniences. There are large shopping malls (Lotte, AK Young Plaza), convenient stores, underground shopping malls, street foods, big chain grocery stores, many restaurants and cafes, and Rodeo Street nearby. As universities and hagwons are nearby, you will also see a lot of students spending time here.', '/images/SuwonStation_1.jpg'),

('Wolhwawon Garden', '경기도 수원시 팔달구 인계동', '399 Dongsuwon-ro, Paldal-gu, Suwon-si, Gyeonggi-do', 'Explore', 'Wolhwawon Garden is located in Hyowon Park (효원공원). It is famous among locals for its chinese-style garden. Many people go here during the fall to look at the fall foliage.', '/images/WolhwawonGarden_1.jpg');
